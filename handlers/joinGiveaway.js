...
module.exports = (client27) => {
    ...
    if(interaction.isButton()) {
        if(interaction.customId == "join_giveaway") {
            ...
            if (!Array.isArray(giveaways)) giveaways = giveaways ? Object.values(giveaways) : [];
            if (!giveaways.length) return interaction.editReply({content:`**لم يتم العثور على هذا الجيف اواي**` , ephemeral:true})
        ...
        if (!Array.isArray(entries)) { entries = []; giveaway.entries = entries; }
